...
{
    #[Route('/', name: 'app_back_player_index', methods: ['GET'])]
    ...
    #[Route('/{id}', name: 'app_back_player_show', methods: ['GET'])]
    public function show(Player $player): Response
    {
        return $this->render('back/player/show.html.twig', [
            'player' => $player,
        ]);
    }
    ...
    #[Route('/{id}', name: 'app_back_player_delete', methods: ['POST'])]
